<?php
include("./cp/includes/header.inc.php");
...
$installed = $tbdb->query("SELECT * FROM users");
if ($installed) die('<h1>Already Installed</h1><p>You appear to have already installed Throwback. To reinstall please clear your old database tables first</p><br><h3><a href="cp/index.php">Proceed to Login</a></h3></body></html>');
?>
...
(0, 'root', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', '1317225558');");
echo("<font color='green'> Done</font><br>");
